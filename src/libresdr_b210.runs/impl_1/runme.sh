...
HD_PWD='/home/f4tnk/dev/LibreSDR_UHD_B220_Mini_FPGA/src/libresdr_b210.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log libresdr_b210.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source libresdr_b210.tcl -notrace
