...
HD_PWD='/home/f4tnk/dev/LibreSDR_UHD_B220_Mini_FPGA/src/libresdr_b210.runs/fifo_4k_2clk_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_4k_2clk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_4k_2clk.tcl
