...
HD_PWD='/home/f4tnk/dev/LibreSDR_UHD_B220_Mini_FPGA/src/libresdr_b210.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log libresdr_b210.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source libresdr_b210.tcl
